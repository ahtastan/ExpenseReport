...
_VISION_PROMPT_DATE_ONLY = (
    ...
    "DD.MM.YYYY, or YYYY/MM/DD; convert them to YYYY-MM-DD.\n"
    ...
    "  Do not return dates with unreadable or invalid years; if the year is "
    "unreadable, return null rather than guessing.\n"
